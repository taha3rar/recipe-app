                ...
                <div class="col-md-8 col-lg-8 col-xl-8">
                    <div class="card" style="border-radius: 15px;">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <div class="d-flex flex-row justify-content-end mt-1 mb-4 text-dark">
                                        <p class="small text-muted"> <?php echo $user['followers'] ?? '0' ?> Followers</p>
                        ...
                        <div class="card-body pb-2">
                            <div class="d-flex justify-content-between">
                                <p>
                                    <spam class="text-dark">Recipes</spam>
                                </p>
                            </div>
                            <a href="recipes.php?id=<?php echo $user_id ?>" class="break-spaces"><?php echo $user['recipe_count'] ?? '0' ?></a>
                        </div>
                        <hr class="my-0" />
                        <div class="card-body pb-2">
                            <div class="d-flex justify-content-between">
                                <p>
                                    <spam class="text-dark">Points</spam>
                                </p>
                            </div>
                            <p class="break-spaces text-success"><?php echo $user['points'] ?? '0' ?></p>
                        </div>
                        <div>
                            <?php if (!$mine) { ?>
                                <hr class="my-0" />
